...
| **2** | **Animation-friendly viewer + View API** | **Phase 5dx done; 5e next** | Through 5dx hygiene. Next: Cylinder/Arrow (5e), Text (5f). |
...
### 2. Animation / composition infra — Phase 5dx done; 5e next
...
- [x] **Track 2** — Phase 5 through 5dx; **5e** Cylinder/Arrow and **5f** Text next
...
- Phase 5a–5dx done. Next: **5e** Cylinder/Arrow; **5f** Text.
